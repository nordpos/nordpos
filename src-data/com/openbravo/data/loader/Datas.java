...
public abstract class Datas {
    ...
    public final static Datas PROPERTIES = new DatasPROPERTIES();
    ...
    private static final class DatasPROPERTIES extends Datas {
        ...
        public void setValue(DataWrite dw, int i, Object value) throws BasicException {
            ...
            try {
                ((Properties) value).storeToXML(outputStream, "Properties", "UTF-8");
                dw.setBytes(i, outputStream.toByteArray());
                outputStream.close();
            } catch (IOException ex) {
                throw new BasicException(ex);
            }
        ...
        @Override
        protected int compareAbstract(Object o1, Object o2) {
            return ((Properties) o1).toString().compareTo(((Properties) o2).toString());
        }
