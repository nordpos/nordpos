...
import com.nordpos.device.escpos.UnicodeTranslatorSurePOS;
import com.nordpos.device.escpos.UnicodeTranslator;
...
public class DeviceDisplaySurePOS extends DeviceDisplaySerial {
    ...
    public DeviceDisplaySurePOS(Writter display) {
